...
class RegisterForm(FlaskForm):
    ...
    emailField = StringField("Email", validators=[DataRequired()])
    passwordField = PasswordField('Password', validators=[DataRequired()])
    submitField = SubmitField('SIGN ME UP!')

class LoginForm(FlaskForm):
    emailField = StringField("Email", validators=[DataRequired()])
    passwordField = PasswordField('Password', validators=[DataRequired()])
    submitField = SubmitField('LOG ME UP!')
...
def register():
    ...
    if User.query.filter_by(email=email).first():
        flash("You have already signed up for the blog!\nPLease Log in to continue.")
        return redirect(url_for('login'))
    if form.validate_on_submit():
        hash_and_salted_password = generate_password_hash(
            form.passwordField.data,
